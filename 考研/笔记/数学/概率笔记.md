...
3. $DS^2=\frac{2\sigma^4}{n-1}$
   + 由$\frac{(n-1)S^2}{\sigma^2}\sim\chi^2(n-1)推导$
...
+ 性质：
  ...
  $(3)可加性:\chi_1^2\sim\chi_1^2(n_1),\chi_2^2\sim\chi_2^2(n_2),且\chi_1^2,\chi_2^2独立,则\chi_1^2+\chi_2^2\sim\chi(n_1+n_2)$
...
+ 结论：$\chi_\alpha^2(1)=U^2_{\frac{\alpha}{2}};F_\alpha(1,n)=t^2_{\frac{\alpha}{2}}(n)$
...
+ 根据$\mu和\sigma^2已知和未知,以及假设检验的是\mu还是sigma^2, 分为四种情况$
