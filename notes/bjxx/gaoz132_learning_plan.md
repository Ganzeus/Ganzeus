...
- 三项目 `README.md`
- ⭐ [Eyeriss NeurIPS 2019 Tutorial PDF](https://eyeriss.mit.edu/2019_neurips_tutorial.pdf) — **本周必读**，建立 NPU/PE array 直觉，图多易懂（约 80 页，半天看完）
...
- ⭐ [Eyeriss ISCA 2016 论文 PDF](https://eems.mit.edu/wp-content/uploads/2016/04/eyeriss_isca_2016.pdf) — 重点读 Section 3-4，理解 dataflow 和 PE array 如何决定 mapping cost
- [Eyeriss v2 论文（arXiv）](https://arxiv.org/abs/1807.07928) — 选读，讲稀疏 + flexible dataflow
...
| # | 资料 | 难度 | 语言 | 用在哪周 | 为什么 |
|---|---|---|---|---|---|
| S1 | [Eyeriss NeurIPS 2019 Tutorial PDF](https://eyeriss.mit.edu/2019_neurips_tutorial.pdf) | ⭐⭐ | 英文 | W1 | 建立 NPU/PE array/dataflow 直觉，图多，最易懂的硬件入门 |
| S2 | [Eyeriss ISCA 2016 论文 PDF](https://eems.mit.edu/wp-content/uploads/2016/04/eyeriss_isca_2016.pdf) | ⭐⭐⭐ | 英文 | W5 | stschedule 硬件模型的理论基础，读懂 cost function 的来源 |
...
#### L4 · LLM 推理优化（建议：Year 2，如果方向转向大模型）

| 资料 | 链接 | 说明 |
|---|---|---|
| Flash Attention 论文 | [arXiv 2205.14135](https://arxiv.org/abs/2205.14135) | 理解 LLM 推理里最核心的 kernel 优化思想 |
...
**为什么学**：大模型推理岗位是目前技术市场最热、薪资溢价最高的方向。你已有 Triton 背景，这是进入该赛道最自然的桥梁。
